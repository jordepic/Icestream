...
public record IcestreamTableConfig(PrimaryKeySchema primaryKey, int indexBuckets, int cassandraPartitionsPerHost) {
    ...
    public static IcestreamTableConfig from(Table table) {
        return new IcestreamTableConfig(
                ...
                Integer.parseInt(getOrDefault(table, IcestreamProperties.INDEX_BUCKETS, "1")),
