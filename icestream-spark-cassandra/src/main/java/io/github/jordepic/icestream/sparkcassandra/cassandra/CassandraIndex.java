...
public final class CassandraIndex implements IndexBackend {
    ...
    @Override
    public void initializeForTable(TableIdentifier table, IcestreamTableConfig config) {
        createIfAbsent(table);
    }
